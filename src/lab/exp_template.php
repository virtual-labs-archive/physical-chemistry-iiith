...
<!-- The lab Header contains the logo and the name of the lab,
	...
	id="experiment-article-breadcrumb"><a href="<?php echo $vlab_url?>">Home</a><a></a> &gt; <a href="<?php echo $lab_url?>">Physical Chemistry Lab</a>    </div>
  ...
  footer-->
   <footer id="lab-footer" class="footer">
	...
	<a href="http://www.sakshat.ac.in/">Sponsered by MHRD (NME-ICT) </a> | <a href="http://www.sakshat.ac.in/" target="_blank"> Licensing Terms </a> | <a href="http://virtual-labs.ac.in/feedback/?lab=ccnsb04/" target="_blank"> Feedback </a>
  </footer>
