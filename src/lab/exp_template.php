...
<!-- The lab Header contains the logo and the name of the lab,
  ...
  footer-->
   <footer id="lab-footer" class="footer">
	...
	<a href="http://www.sakshat.ac.in/frmIndex.aspx">Sponsered by MHRD (NME-ICT) </a> | <a href="http://www.sakshat.ac.in/" target="_blank"> Licensing Terms </a> | <a href="http://feedback.vlabs.ac.in/" target="_blank"> Feedback </a>
  </footer>
