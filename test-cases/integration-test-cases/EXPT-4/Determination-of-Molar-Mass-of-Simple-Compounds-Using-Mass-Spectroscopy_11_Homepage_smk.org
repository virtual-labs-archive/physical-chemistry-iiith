...
* Objective
   ...
   + To be able to simulate the "Determination of Molar Mass of Simple Compounds Using Mass Spectroscopy" experiment
...
* Test Steps
  ...
  +  Click on the "Determination of Molar Mass of Simple Compounds Using Mass Spectroscopy" link.
  +  Check if there are any distortions, spelling mistakes and junk
     characters in the Simulation page.

* Expected result

  + The home page of "Determination of Molar Mass of Simple Compounds Using Mass Spectroscopy" experiment should be displayed on the screen.
